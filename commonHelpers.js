import{l as s,g as p,i as y}from"./assets/footer-282a0e6f.js";import{f as L}from"./assets/vendor-58a52777.js";const m="/js-94_krok-code/assets/yellow-shopping-basket-7c9e4c8c.webp",g="/js-94_krok-code/assets/yellow-shopping-basket@2x-16bffe16.webp",k="/js-94_krok-code/assets/yellow-shopping-basket_mob-d3bbad76.webp",S="/js-94_krok-code/assets/yellow-shopping-basket_mob@2x-b0f89c1a.webp",M="/js-94_krok-code/assets/yellow-shopping-basket-014cc855.png";function f(){const e=s.load("product");document.querySelector(".cart-number-purchases").innerHTML=`${e?e.length:"0"} `}f();const c=s.load("product");document.addEventListener("DOMContentLoaded",e=>{c.length===0&&(document.querySelector(".section-cart").innerHTML=a()),h()});function b(e){if(e){const t=e.map(r=>w(r)).join("");document.querySelector(".cart-shopping-list").innerHTML=t}else document.querySelector(".section-cart").innerHTML=a()}b(c);document.querySelector(".delete-all-box").addEventListener("click",()=>{s.remove("product"),p(),document.querySelector(".section-cart").innerHTML=a()});const i=document.querySelector(".cart-shopping-list ");i.addEventListener("click",q);function q(e){if(!e.target.closest(".cart-delete-icon"))return;localStorage.setItem("product",JSON.stringify());const r=e.target.closest("li").dataset.productId,o=c.findIndex(n=>n.id===r);o!==-1&&c.splice(o,1),localStorage.setItem("product",JSON.stringify(c)),b(c),d(),h(),f(),p(),c.length===0&&(document.querySelector(".section-cart").innerHTML=a())}function w(e){let{id:t,name:r,img:o,category:n,size:l,price:u}=e;const v=n.replace(/_/g," ");return`
